...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/phoebe/helpers/` and `examples/` directory.
...
```ruby
gem "phoebe", git: "https://www.github.com/stainless-sdks/phoebe-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/stainless-sdks/phoebe-ruby' '<path-to-repo>'
```

```ruby
gem "phoebe", path: "<path-to-repo>"
```
