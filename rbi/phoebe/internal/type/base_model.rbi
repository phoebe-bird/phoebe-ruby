    ...
    module Type
      class BaseModel
        ...
        class << self
          ...
          sig { params(child: Phoebe::Internal::Type::BaseModel).void }
          def inherited(child)
          end
            ...
            params(
              ...
              type_info:
                T.any(
                  ...
                  T.proc.returns(Phoebe::Internal::Type::Converter::Input),
                  Phoebe::Internal::Type::Converter::Input
                ),
              spec: Phoebe::Internal::AnyHash
            ).void
          end
        ...
        class << self
          ...
          sig do
            params(
              model: Phoebe::Internal::Type::BaseModel,
              convert: T::Boolean
            ).returns(Phoebe::Internal::AnyHash)
          end
        ...
        sig { overridable.returns(Phoebe::Internal::AnyHash) }
        def to_h
        end
