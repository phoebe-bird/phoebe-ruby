  ...
  module Models
    module Product
      class ListRetrieveResponseItem < Phoebe::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Phoebe::Models::Product::ListRetrieveResponseItem::Loc)
          )
        end
        attr_reader :loc
        ...
        sig do
          params(
            loc: Phoebe::Models::Product::ListRetrieveResponseItem::Loc::OrHash
          ).void
        end
        attr_writer :loc
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Phoebe::Models::Product::ListRetrieveResponseItem::Ob]
            )
          )
        end
        attr_reader :obs
        ...
        sig do
          params(
            obs:
              T::Array[
                Phoebe::Models::Product::ListRetrieveResponseItem::Ob::OrHash
              ]
          ).void
        end
        attr_writer :obs
          ...
          override.returns(
            {
              ...
              iso_obs_date: String,
              last_edited_dt: String,
              loc: Phoebe::Models::Product::ListRetrieveResponseItem::Loc,
              loc_id: String,
              num_observers: Integer,
              num_species: Integer,
              obs:
        ...
        class Ob < Phoebe::Internal::Type::BaseModel
          ...
          sig do
            params(
              obs_aux:
                T::Array[
                  Phoebe::Models::Product::ListRetrieveResponseItem::Ob::ObsAux::OrHash
                ]
            ).void
          end
          attr_writer :obs_aux
