  ...
  module Models
    module Product
      class ListRetrieveResponseItem < Phoebe::Internal::Type::BaseModel
        ...
        # @!attribute loc
        #
        #   @return [Phoebe::Models::Product::ListRetrieveResponseItem::Loc, nil]
        ...
        # @!attribute obs
        #
        #   @return [Array<Phoebe::Models::Product::ListRetrieveResponseItem::Ob>, nil]
        optional :obs,
        ...
        #   @param loc [Phoebe::Models::Product::ListRetrieveResponseItem::Loc]
        #   @param loc_id [String]
        #   @param num_observers [Integer]
        #   @param num_species [Integer]
        #   @param obs [Array<Phoebe::Models::Product::ListRetrieveResponseItem::Ob>]
        #   @param obs_dt [String]
        ...
        # @see Phoebe::Models::Product::ListRetrieveResponseItem#loc
        ...
        class Ob < Phoebe::Internal::Type::BaseModel
          # @!attribute obs_aux
          #
          #   @return [Array<Phoebe::Models::Product::ListRetrieveResponseItem::Ob::ObsAux>, nil]
          optional :obs_aux,
                   -> { Phoebe::Internal::Type::ArrayOf[Phoebe::Models::Product::ListRetrieveResponseItem::Ob::ObsAux] },
                   api_name: :obsAux
          ...
          #   @param obs_aux [Array<Phoebe::Models::Product::ListRetrieveResponseItem::Ob::ObsAux>]
          #   @param obs_dt [String]
          #   @param obs_id [String]
      ...
      ListRetrieveResponse =
        Phoebe::Internal::Type::ArrayOf[-> { Phoebe::Models::Product::ListRetrieveResponseItem }]
    end
  end
end
