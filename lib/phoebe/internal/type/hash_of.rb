    ...
    module Type
      ...
      class HashOf
        ...
        def ==(other)
          ...
          other.is_a?(Phoebe::Internal::Type::HashOf) && other.nilable? == nilable? && other.item_type == item_type
            ...
            .to_h do |key, val|
              ...
              v =
                ...
                in [true, nil]
                  ...
                  Phoebe::Internal::Type::Converter.coerce(target, val, state: state)
                end
        ...
        # @return [Object]
        def to_sorbet_type
          T::Hash[Phoebe::Internal::Util::SorbetRuntimeSupport.to_sorbet_type(item_type)]
        end
