    ...
    module Type
      ...
      class BaseModel
        ...
        class << self
          ...
          def known_fields
            @known_fields ||= (self < Phoebe::Internal::Type::BaseModel ? superclass.known_fields.dup : {})
          end
          ...
          private def add_field(name_sym, required:, type_info:, spec:)
            ...
            define_method(name_sym) do
              ...
              raise Phoebe::Errors::ConversionError.new(message)
            end
          end
        ...
        class << self
          ...
          #
          # @return [Phoebe::Internal::Type::BaseModel, Object]
          ...
          # @api private
          #
          # @param value [Phoebe::Internal::Type::BaseModel, Object]
          #
          # @param state [Hash{Symbol=>Object}] .
          #
        ...
        def initialize(data = {}) = (@data = Phoebe::Internal::Util.coerce_hash!(data).to_h)
