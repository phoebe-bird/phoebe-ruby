  ...
  module Internal
    module Type
      ...
      class FileInput
        ...
        def self.===(other)
          case other
          in Pathname | StringIO | IO | String | Phoebe::FilePart
            true
          else
            false
          end
        ...
        #
        # @return [Boolean]
        def self.==(other) = other.is_a?(Class) && other <= Phoebe::Internal::Type::FileInput
        ...
        class << self
          ...
          def dump(value, state:)
            ...
            in StringIO | String
              ...
              Phoebe::FilePart.new(value, filename: "upload")
            in IO
              state[:can_retry] = false
              value.to_path.nil? ? Phoebe::FilePart.new(value, filename: "upload") : value
            in Phoebe::FilePart if value.content.is_a?(IO)
              state[:can_retry] = false
              value
            else
              value
