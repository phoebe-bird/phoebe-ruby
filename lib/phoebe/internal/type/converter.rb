    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { Phoebe::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { Phoebe::Internal::Type::Unknown.dump(_1, state: state) }
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in Phoebe::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [Phoebe::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: Phoebe::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in Phoebe::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in Phoebe::Internal::Type::Converter
              ...
              Phoebe::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(Phoebe::Internal::Type::Converter, T::Class[T.anything]) }
        end
