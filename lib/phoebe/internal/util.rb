    ...
    module Util
      ...
      class << self
        ...
        def encode_content(headers, body)
          ...
          in [Phoebe::Internal::Util::JSON_CONTENT, Hash | Array | -> { primitive?(_1) }]
            [headers, JSON.generate(body)]
          in [Phoebe::Internal::Util::JSONL_CONTENT, Enumerable] unless body.is_a?(Phoebe::Internal::Type::FileInput)
            [headers, body.lazy.map { JSON.generate(_1) }]
          in [%r{^multipart/form-data}, Hash | Phoebe::Internal::Type::FileInput]
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          # @api private
          #
          # @param type [Phoebe::Internal::Util::SorbetRuntimeSupport, Object]
          #
          # @return [Object]
          def to_sorbet_type(type)
            case type
            in Phoebe::Internal::Util::SorbetRuntimeSupport
              type.to_sorbet_type
            else
              type
            end
