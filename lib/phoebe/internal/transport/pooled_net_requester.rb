      ...
      class PooledNetRequester
        ...
        class << self
          ...
          def calibrate_socket_timeout(conn, deadline)
            timeout = deadline - Phoebe::Internal::Util.monotonic_secs
        ...
        private def with_pool(url, deadline:, &blk)
          origin = Phoebe::Internal::Util.uri_origin(url)
          timeout = deadline - Phoebe::Internal::Util.monotonic_secs
          pool =
        ...
        def execute(request)
          ...
          enum = Enumerator.new do |y|
            ...
            raise Phoebe::Errors::APITimeoutError.new(url: url, request: req)
          rescue StandardError
            raise Phoebe::Errors::APIConnectionError.new(url: url, request: req)
          end
          # rubocop:enable Metrics/BlockLength

          conn, _, response = enum.next
          body = Phoebe::Internal::Util.fused_enum(enum, external: true) do
            finished = true
            tap do
              enum.next
