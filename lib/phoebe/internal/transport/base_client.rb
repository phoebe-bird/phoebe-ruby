    ...
    module Transport
      ...
      class BaseClient
        ...
        def initialize(
          ...
          @base_url_components = Phoebe::Internal::Util.parse_uri(base_url)
          @base_url = Phoebe::Internal::Util.unparse_uri(@base_url_components)
        ...
        #
        # @return [String]
        private def user_agent = "#{self.class.name}/Ruby #{Phoebe::VERSION}"
