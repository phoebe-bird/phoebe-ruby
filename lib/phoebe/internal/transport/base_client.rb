  ...
  module Internal
    module Transport
      ...
      class BaseClient
        ...
        PLATFORM_HEADERS =
          {
            "x-stainless-arch" => Phoebe::Internal::Util.arch,
            "x-stainless-lang" => "ruby",
            "x-stainless-os" => Phoebe::Internal::Util.os,
            "x-stainless-package-version" => Phoebe::VERSION,
        ...
        class << self
          ...
          def should_retry?(status, headers:)
            coerced = Phoebe::Internal::Util.coerce_boolean(headers["x-should-retry"])
            case [coerced, status]
            in [true | false, _]
              coerced
          ...
          def follow_redirect(request, status:, response_headers:)
            ...
            location =
              Kernel.then do
                ...
                raise Phoebe::Errors::APIConnectionError.new(
                  url: url,
            ...
            # from undici
            if Phoebe::Internal::Util.uri_origin(url) != Phoebe::Internal::Util.uri_origin(location)
          ...
          # @api private
          #
          # @param status [Integer, Phoebe::Errors::APIConnectionError]
          # @param stream [Enumerable<String>, nil]
          def reap_connection!(status, stream:)
            case status
            in (..199) | (300..499)
              stream&.each { next }
            in Phoebe::Errors::APIConnectionError | (500..)
              Phoebe::Internal::Util.close_fused!(stream)
            else
            end
          end
        end
        ...
        # @api private
        # @return [Phoebe::Internal::Transport::PooledNetRequester]
        ...
        def initialize(
          ...
          @requester = Phoebe::Internal::Transport::PooledNetRequester.new
          @headers = Phoebe::Internal::Util.normalized_headers(
          ...
          @base_url = Phoebe::Internal::Util.parse_uri(base_url)
        ...
        #
        #   @option req [Class<Phoebe::Internal::Type::BasePage>, nil] :page
        #
        #   @option req [Class<Phoebe::Internal::Type::BaseStream>, nil] :stream
        #
        #   @option req [Phoebe::Internal::Type::Converter, Class, nil] :model
        #
        ...
        private def build_request(req, opts)
          ...
          path = Phoebe::Internal::Util.interpolate_path(uninterpolated_path)

          query = Phoebe::Internal::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
          ...
          headers, encoded = Phoebe::Internal::Util.encode_content(headers, body)
          {
            method: method,
            url: Phoebe::Internal::Util.join_parsed_uri(@base_url, {**req, path: path, query: query}),
            headers: headers,
            body: encoded,
        ...
        private def send_request(request, redirect_count:, retry_count:, send_retry_header:)
          ...
          in 300..399 if redirect_count >= self.class::MAX_REDIRECTS
            ...
            raise Phoebe::Errors::APIConnectionError.new(url: url, response: response, message: message)
          in 300..399
            self.class.reap_connection!(status, stream: stream)
          ...
          in (400..) | Phoebe::Errors::APIConnectionError
            self.class.reap_connection!(status, stream: stream)
        ...
        # methods call into.
        #
        # @overload request(method, path, query: {}, headers: {}, body: nil, unwrap: nil, page: nil, stream: nil, model: Phoebe::Internal::Type::Unknown, options: {})
        #
        # @param method [Symbol]
        #
        ...
        #
        # @param page [Class<Phoebe::Internal::Type::BasePage>, nil]
        #
        # @param stream [Class<Phoebe::Internal::Type::BaseStream>, nil]
        #
        # @param model [Phoebe::Internal::Type::Converter, Class, nil]
        #
        # @param options [Phoebe::RequestOptions, Hash{Symbol=>Object}, nil] .
        #
        ...
        def request(req)
          ...
          model = req.fetch(:model) { Phoebe::Internal::Type::Unknown }
          opts = req[:options].to_h
          Phoebe::RequestOptions.validate!(opts)
          ...
          in {page: Class => page}
            ...
            unwrapped = Phoebe::Internal::Util.dig(decoded, req[:unwrap])
        ...
        def inspect
          ...
          base_url = Phoebe::Internal::Util.unparse_uri(@base_url)
          ...
          T.type_alias do
            {
              ...
              page: T.nilable(T::Class[Phoebe::Internal::Type::BasePage[Phoebe::Internal::Type::BaseModel]]),
              stream: T.nilable(T::Class[T.anything]),
              model: T.nilable(Phoebe::Internal::Type::Converter::Input),
              options: T.nilable(Phoebe::RequestOptions::OrHash)
            }
          end
        end
