...
class Phoebe::Test::SingletonClient < Phoebe::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: Phoebe::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class Phoebe::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @phoebe = Phoebe::Test::SingletonClient.instance
  end
