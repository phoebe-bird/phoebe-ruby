...
class Phoebe::Test::SorbetRuntimeSupportTest < Minitest::Test
  ...
  class M < Phoebe::Internal::Type::BaseModel
  ...
  def test_nil_aliases
    ...
    assert_raises(err) { Phoebe::Internal::Type::BaseModel::KnownField }
    assert_raises(err) { Phoebe::Internal::Util::ParsedUri }
    assert_raises(err) { Phoebe::Internal::Util::ServerSentEvent }
    assert_raises(err) { Phoebe::Internal::Transport::BaseClient::RequestComponents }
    assert_raises(err) { Phoebe::Internal::Transport::BaseClient::RequestInput }
    assert_raises(err) { Phoebe::Internal::Transport::PooledNetRequester::Request }
