...
class Phoebe::Test::PrimitiveModelTest < Minitest::Test
  A = Phoebe::Internal::Type::ArrayOf[-> { Integer }]
  H = Phoebe::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  module U
    extend Phoebe::Internal::Type::Union
  end

  class B < Phoebe::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Phoebe::Internal::Type::Unknown,
      Phoebe::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Phoebe::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Phoebe::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Phoebe::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Phoebe::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Phoebe::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Phoebe::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Phoebe::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Phoebe::Internal::Type::Boolean, true] => true,
      [Phoebe::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Phoebe::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Phoebe::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Phoebe::Internal::Type::Converter.new_coerce_state
      Phoebe::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Phoebe::Internal::Type::Converter.dump(target, input, state: state)
...
class Phoebe::Test::EnumModelTest < Minitest::Test
  class E0
    include Phoebe::Internal::Type::Enum
...
class Phoebe::Test::CollectionModelTest < Minitest::Test
  A1 = Phoebe::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Phoebe::Internal::Type::HashOf[Integer]

  A2 = Phoebe::Internal::Type::ArrayOf[H1]
  H2 = Phoebe::Internal::Type::HashOf[-> { A1 }]

  A3 = Phoebe::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Phoebe::Internal::Type::HashOf[Integer, nil?: true]
...
class Phoebe::Test::BaseModelTest < Minitest::Test
  class M1 < Phoebe::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Phoebe::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Phoebe::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Phoebe::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Phoebe::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Phoebe::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Phoebe::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Phoebe::Errors::ConversionError => e
...
class Phoebe::Test::UnionTest < Minitest::Test
  class U0
    include Phoebe::Internal::Type::Union
  ...
  class M2 < Phoebe::Internal::Type::BaseModel
  ...
  class M4 < Phoebe::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Phoebe::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Phoebe::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Phoebe::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Phoebe::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Phoebe::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Phoebe::Internal::Type::Unknown, Phoebe::Internal::Type::Unknown] => true,
      [Phoebe::Internal::Type::Boolean, Phoebe::Internal::Type::Boolean] => true,
      [Phoebe::Internal::Type::Unknown, Phoebe::Internal::Type::Boolean] => false,
...
class Phoebe::Test::MetaInfoTest < Minitest::Test
  A1 = Phoebe::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Phoebe::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
